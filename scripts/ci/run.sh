...
echo "  3) scripts/ci/jobs/core-checks.sh"
echo "  4) scripts/ci/jobs/backend-checks.sh"
echo "  5) scripts/ci/jobs/frontend-checks.sh"
echo "  6) scripts/ci/jobs/openapi-drift.sh"
echo "  7) scripts/ci/jobs/docker-build.sh"
echo "  8) scripts/ci/jobs/docker-smoke.sh"
echo "  9) scripts/ci/jobs/guardrails.sh"
echo ""

bash "${SCRIPT_DIR}/doctor.sh"
bash "${SCRIPT_DIR}/jobs/native-build.sh"
bash "${SCRIPT_DIR}/jobs/core-checks.sh"
